...
1. Скачайте `FunPayServer.exe` со страницы **[релизов](https://github.com/minato4kaYT/FunPayServer-v2)**.
...
2. Скачайте данный **[репозиторий](https://github.com/minato4kaYT/FunPayServer-v2)**.
...
- VKONTAKTE - (https://vk.com/itsminatoyt)

Более долгий ответ:

- Telegram - (https://t.me/xdeadlyforminato)
